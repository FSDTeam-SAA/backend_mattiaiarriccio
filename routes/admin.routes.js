...
const adminSettingsUpload = upload.fields([
  { name: 'avatar', maxCount: 1 },
  { name: 'avatarImage', maxCount: 1 },
  { name: 'avatarImageFile', maxCount: 1 },
...
router.patch('/settings', adminSettingsUpload, updateAdminSettings);
